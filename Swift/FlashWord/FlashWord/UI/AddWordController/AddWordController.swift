...
class AddWordController: DYViewController {
...
extension AddWordController : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
