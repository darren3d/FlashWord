...
class AddWordBookController: DYViewController {
...
extension AddWordBookController : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
